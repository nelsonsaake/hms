...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="xdark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-blue-950 dark:border-blue-700 dark:bg-blue-900">
            ...
            <!-- Desktop User Menu -->
            <flux:dropdown class="hidden lg:block bg-white rounded-lg" position="bottom" align="start">
                <flux:profile
                    :name="auth()->user()->name"
