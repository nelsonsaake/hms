<x-layouts.app :title="__('Room Images')">
            ...
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700 w-full table-auto">
                ...
                @forelse ($roomImages as $v)
                    <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50">
                        <td class="px-4 py-3 text-sm text-neutral-700 dark:text-gray-100 w-1">
                        ...
                        <td class="px-4 py-2">
                            <div class="flex gap-2">
                                <!-- View -->
                                <a
                                    href="{{route('room_images.show', $v->id)}}"
                                ...
                                <!-- Delete -->
                                <form
                                    action="{{route('room_images.destroy', $v->id)}}"
                                    method="POST"
